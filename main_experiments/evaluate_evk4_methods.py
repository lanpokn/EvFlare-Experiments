...
def get_sample_pairs_evk4(gt_folder: str, method_folders: List[str], num_samples: int = None) -> List[Dict]:
    ...
    gt_files = sorted(list(gt_path.glob('evk4_*ms_sample*.h5')))
    ...
    for gt_file in gt_files:
        # Extract sample identifier (e.g., "25ms_sample1" from "evk4_25ms_sample1.h5")
        gt_name = gt_file.stem  # evk4_25ms_sample1
        sample_id = gt_name.replace('evk4_', '')  # 25ms_sample1
        ...
        for method_folder in method_folders:
            ...
            # Look for matching file in method folder
            method_file = method_path / f"evk4_{sample_id}.h5"
